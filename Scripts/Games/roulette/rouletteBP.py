...
rouletteBP = Blueprint("roulette",__name__,url_prefix="/games/roulette")
CORS(rouletteBP, origins=["http://localhost:63342"])

#Here comes the correct number
@rouletteBP.route('/getnumbers/<moneyToGamble>')
...
@rouletteBP.route('/numbercheck', methods=['POST'])
