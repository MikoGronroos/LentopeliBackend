...
highCardLowCard = Flask(__name__)
CORS(highCardLowCard, origins=["http://localhost:63342"])

#Here comes the starting values like playerCard, dealerCard and playerGuessedCorrectly
@highCardLowCard.route('/games/highCardLowCard/getcards/<moneyToGamble>')
...
@highCardLowCard.route('/games/highCardLowCard/highlow', methods=['POST'])
...
if __name__ == '__main__':
    highCardLowCard.run(use_reloader=True, host='127.0.0.1', port=3000)